...
from core.llm import llm_intent_parser as lightweight_intent    # 轻量意图分类（只判断 intent）
from core.llm.llm_client import safe_llm_chat
from app.services.energy_query_runner import run_energy_query
from core.llm.llm_time_parser import parse_time_question
